...
@section('title')
    Shortlink Belum Dibuka -
@endsection

@section('content')
    <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-black dark:text-light">Belum Dibuka</h1>
    <p class="text-xl sm:text-2xl md:text-3xl font-light text-gray-800 dark:text-gray-200 mt-2">
        Link ini belum bisa diakses sekarang
    </p>
    <p class="text-gray-800 dark:text-gray-200 mt-1">
        Coba lagi nanti saat waktunya sudah tiba
    </p>
