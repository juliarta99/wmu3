...
@section('content')
    ...
    <section class="py-14 md:py-24 relative">
        ...
        <div id="showcases" class="container px-3 mx-auto scroll-mt-24">
            <form method="GET" action="{{ route('showcase.index') }}#showcases" class="flex items-center gap-5 rounded-lg pl-5 pr-2 shadow-lg bg-light dark:bg-[#282828] border-[1px] border-gray-200 dark:border-gray-600">
            ...
            @if(request()->hasAny(['search']))
                <div class="mt-4 p-4 bg-blue-50 dark:bg-one border border-blue-200 dark:border-two rounded-lg">
            ...
            @if ($showcases->count() == 0)
                <div class="text-black dark:text-light mt-5">
                    <svg class="w-16 h-16 text-gray-800 dark:text-gray-50 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path>
                    </svg>
                    <p class="text-center text-lg font-medium">Tidak ada data karya peserta</p>
                    @if(request('search'))
                        <p class="text-center text-sm">Tidak ditemukan karya peserta dengan kata kunci <span class="text-seven">"{{ request('search') }}"</span></p>
                    @endif
                </div>
            @else
            ...
            @if($showcases->hasPages())
                <div class="mt-6 flex justify-between items-center text-black dark:text-light px-4 py-3">
