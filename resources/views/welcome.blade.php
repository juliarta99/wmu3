        ...
        <div class="container px-3 mx-auto relative">
            ...
            <div class="my-10 max-w-2xl mx-auto">
                ...
                <div class="grid grid-cols-3 gap-3 mt-5">
                    <button type="button" class="rounded-lg md:rounded-xl">
                        <img src="{{ asset('assets/images/img.png') }}" class="rounded-lg md:rounded-xl w-full aspect-video object-cover" alt="">
                    </button>
                    <button type="button" class="rounded-lg md:rounded-xl">
                        <img src="{{ asset('assets/images/img.png') }}" class="rounded-lg md:rounded-xl grayscale-100 w-full aspect-video object-cover" alt="">
                    </button>
                    <button type="button" class="rounded-lg md:rounded-xl">
                        <img src="{{ asset('assets/images/img.png') }}" class="rounded-lg md:rounded-xl grayscale-100 w-full aspect-video object-cover" alt="">
                    </button>
        ...
        <div class="container px-3 mx-auto">
            ...
            <div class="my-10 grid md:grid-cols-[1fr_max-content_1fr] relative max-w-5xl mx-auto">
                ...
                <div class="w-full p-5 ">
                    <div class="w-full rounded-xl border-[1px] border-[#FCFDFD]/50 bg-[#9489AB] p-5">
                        <div class="flex gap-3 items-center opacity-50">
                            ...
                            <p class="text-xs sm:text-sm text-light">Kamis, 12 Desember - Selasa, 15 Desember 2025</p>
                        </div>
                        <h3 class="opacity-50 text-md md:text-lg font-bold uppercase text-light mt-1">Open Registration</h3>
                        <p class="opacity-50 text-light mt-2 text-sm md:text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                ...
                <div class="w-full p-5 ">
                    <div class="w-full rounded-xl border-[1px] border-[#FCFDFD] bg-two p-5">
                        ...
                        <h3 class="text-md md:text-lg font-bold uppercase text-light mt-1">Open Registration</h3>
                        <p class="text-light mt-2 text-sm md:text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                ...
                <div class="mx-auto mt-10 space-y-4 w-full">
                    <div class="faq-item border border-gray-300 dark:border-light rounded-lg overflow-hidden bg-28-transparent hover:bg-light dark:hover:bg-two transition-all duration-200">
                        <button class="faq-btn cursor-pointer w-full text-left flex justify-between items-center p-4">
                            <span class="text-black dark:text-light font-medium text-sm md:text-base">Apa itu Workshop Multimedia Udayana?</span>
                    ...
                    <div class="faq-item border border-gray-300 dark:border-light rounded-lg overflow-hidden bg-28-transparent hover:bg-light dark:hover:bg-two transition-all duration-200">
                        <button class="faq-btn cursor-pointer w-full text-left flex justify-between items-center p-4">
                            <span class="text-black dark:text-light font-medium text-sm md:text-base">Lorem ipsum dolor sit amet consectetur.?</span>
                            <svg class="w-5 h-5 fill-black dark:fill-light transition-transform duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                <path d="M137.4 374.6c12.5 12.5 32.8 12.5 45.3 0l128-128c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8L32 192c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l128 128z"/>
                            </svg>
                        </button>
            ...
            <div class="max-w-2xl grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-10 mx-auto mt-10">
                <div class="rounded-lg border-[1px] border-[#A295AC] p-5 bg-28-transparent flex flex-col gap-5 w-full">
                    <div class="flex items-center gap-3">
                        ...
                        <h5 class="text-seven font-semibold text-base md:text-lg">Min WMU</h5>
                    </div>
                    <div class="flex flex-col gap-2">
                        <a class="flex items-center gap-3">
                            ...
                            <p class="text-sm md:text-base text-black dark:text-light">087482938939</p>
                        </a>
                        <a class="flex items-center gap-3">
                            ...
                            <p class="text-sm md:text-base text-black dark:text-light">linekunih99</p>
                        </a>
                    </div>
                </div>
                <div class="rounded-lg border-[1px] border-[#A295AC] p-5 bg-28-transparent flex flex-col gap-5 w-full">
