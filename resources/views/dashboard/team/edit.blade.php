        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-1">
                ...
                <input 
                    ...
                    id="name" 
                    name="name" 
                    class="border border-gray-300 px-4 py-2 rounded-lg text-sm md:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('name') border-red-500 @enderror" 
            ...
            <div class="flex flex-col gap-1">
                ...
                <input 
                    ...
                    min="2024" 
                    max="{{ now()->year }}" 
                    class="border border-gray-300 px-4 py-2 rounded-lg text-sm md:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('year') border-red-500 @enderror" 
                        ...
                        <div class="contributor-item flex flex-col gap-1" data-contributor="{{ $index + 1 }}">
                            ...
                            @if($index === 0)
                                <input 
                                    ...
                                    name="contributors[]" 
                                    class="border border-gray-300 px-4 py-2 rounded-lg text-sm md:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('contributors.' . $index) border-red-500 @enderror" 
                            ...
                            @else
                                <div class="flex items-center gap-2 md:gap-3 justify-between">
                                    <input 
                                        ...
                                        id="contributor{{ $index + 1 }}" 
                                        name="contributors[]" 
                                        class="border w-full border-gray-300 px-4 py-2 rounded-lg text-sm md:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('contributors.' . $index) border-red-500 @enderror" 
                                        placeholder="Masukkan nama contributor {{ $index + 1 }}"
                                        value="{{ $contributor }}"
                                    >
                                    <button 
                                    ...
                                    >
                                        <svg class="size-5 md:size-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @else
                    <div class="contributor-item flex flex-col gap-1" data-contributor="1">
                        ...
                        <input 
                            ...
                            id="contributor1" 
                            name="contributors[]" 
                            class="border border-gray-300 px-4 py-2 rounded-lg text-sm md:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
