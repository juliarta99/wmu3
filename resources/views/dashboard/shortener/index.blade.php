        ...
        <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-blue-700 font-medium text-sm md:text-base">Filter Aktif:</span>
                    @if(request('search'))
                ...
                <a href="{{ route('dashboard.shortener.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Reset Filter</a>
            </div>
        </div>
    @endif
        ...
        async function showLinkDetail(shortenerBackHalf) {
            try {
                ...
                if (result.success) {
                    ...
                    modal.show({
                        id: 'shortenerDetailModal',
                        title: `Detail Link Shortener`,
                        size: 'lg',
                        ...
                        content: `
                            <div class="space-y-4">
                                <div class="flex flex-col gap-3">
                                    <h1 class="font-medium">${link.name}</h1>
                                    <h3 class="text-sm">Total Kunjungan: ${link.count_visitors}</h3>
                                    <div class="flex gap-2 items-center">
                                        <svg class="size-6 min-w-6 fill-black" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span>Akhiran Link: ${link.back_half}</span>
                                    </div>
                                    <div class="flex gap-2 items-center">
                                        <svg class="size-6 min-w-6 fill-black" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.0832 31.6663C10.5471 31.6663 8.38556 30.7723 6.59867 28.9842C4.81178 27.1961 3.91773 25.0346 3.91651 22.4997C3.91528 19.9648 4.80934 17.8033 6.59867 16.0152C8.38801 14.2271 10.5495 13.333 13.0832 13.333H18.5832C19.1026 13.333 19.5383 13.509 19.8903 13.861C20.2423 14.213 20.4177 14.6481 20.4165 15.1663C20.4153 15.6846 20.2393 16.1203 19.8885 16.4735C19.5377 16.8267 19.1026 17.0021 18.5832 16.9997H13.0832C11.5554 16.9997 10.2568 17.5344 9.18734 18.6038C8.11789 19.6733 7.58317 20.9719 7.58317 22.4997C7.58317 24.0275 8.11789 25.3261 9.18734 26.3955C10.2568 27.465 11.5554 27.9997 13.0832 27.9997H18.5832C19.1026 27.9997 19.5383 28.1757 19.8903 28.5277C20.2423 28.8797 20.4177 29.3148 20.4165 29.833C20.4153 30.3512 20.2393 30.787 19.8885 31.1402C19.5377 31.4934 19.1026 31.6688 18.5832 31.6663H13.0832ZM16.7498 24.333C16.2304 24.333 15.7953 24.157 15.4445 23.805C15.0937 23.453 14.9177 23.0179 14.9165 22.4997C14.9153 21.9815 15.0913 21.5463 15.4445 21.1943C15.7977 20.8423 16.2328 20.6663 16.7498 20.6663H27.7498C28.2693 20.6663 28.705 20.8423 29.057 21.1943C29.409 21.5463 29.5844 21.9815 29.5832 22.4997C29.582 23.0179 29.406 23.4536 29.0552 23.8068C28.7044 24.1601 28.2693 24.3355 27.7498 24.333H16.7498ZM25.9165 31.6663C25.3971 31.6663 24.962 31.4903 24.6112 31.1383C24.2604 30.7863 24.0844 30.3512 24.0832 29.833C24.082 29.3148 24.258 28.8797 24.6112 28.5277C24.9644 28.1757 25.3995 27.9997 25.9165 27.9997H31.4165C32.9443 27.9997 34.2429 27.465 35.3123 26.3955C36.3818 25.3261 36.9165 24.0275 36.9165 22.4997C36.9165 20.9719 36.3818 19.6733 35.3123 18.6038C34.2429 17.5344 32.9443 16.9997 31.4165 16.9997H25.9165C25.3971 16.9997 24.962 16.8237 24.6112 16.4717C24.2604 16.1197 24.0844 15.6846 24.0832 15.1663C24.082 14.6481 24.258 14.213 24.6112 13.861C24.9644 13.509 25.3995 13.333 25.9165 13.333H31.4165C33.9526 13.333 36.1147 14.2271 37.9028 16.0152C39.691 17.8033 40.5844 19.9648 40.5832 22.4997C40.582 25.0346 39.6879 27.1967 37.901 28.986C36.1141 30.7753 33.9526 31.6688 31.4165 31.6663H25.9165Z"/>
                                        </svg>
                                        <span>Link Tujuan: ${link.link}</span>
                                    </div>
                                    <div class="flex gap-2 items-center">
                                        <svg class="size-6 min-w-6 fill-black" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span>Waktu Mulai: ${link.open_at_formatted}</span>
                                    </div>
                                    <div class="flex gap-2 items-center">
                                        <svg class="size-6 min-w-6 fill-black" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 20C14.1217 20 16.1566 19.1571 17.6569 17.6569C19.1571 16.1566 20 14.1217 20 12C20 9.87827 19.1571 7.84344 17.6569 6.34315C16.1566 4.84285 14.1217 4 12 4C9.87827 4 7.84344 4.84285 6.34315 6.34315C4.84285 7.84344 4 9.87827 4 12C4 14.1217 4.84285 16.1566 6.34315 17.6569C7.84344 19.1571 9.87827 20 12 20ZM12 2C13.3132 2 14.6136 2.25866 15.8268 2.7612C17.0401 3.26375 18.1425 4.00035 19.0711 4.92893C19.9997 5.85752 20.7362 6.95991 21.2388 8.17317C21.7413 9.38642 22 10.6868 22 12C22 14.6522 20.9464 17.1957 19.0711 19.0711C17.1957 20.9464 14.6522 22 12 22C6.47 22 2 17.5 2 12C2 9.34784 3.05357 6.8043 4.92893 4.92893C6.8043 3.05357 9.34784 2 12 2ZM12.5 7V12.25L17 14.92L16.25 16.15L11 13V7H12.5Z"/>
                                        </svg>
                                        <span>Waktu Berakhir: ${link.end_at_formatted}</span>
                                    </div>
                                    <div class="flex gap-2 items-center">
                                        <a href="${link.access_link}" target="_blank" class="flex items-center gap-2">
                                            <span class="text-five">Akses Link</span>
                    ...
                    modal.alert({
                        title: 'Error',
                        message: result.message || 'Gagal mengambil detail link',
