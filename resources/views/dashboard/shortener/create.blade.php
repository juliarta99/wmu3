...
@section('content')
    <div class="flex items-center gap-3">
        ...
        <span class="text-xl md:text-2xl font-bold">Add <span class="text-five">Shortener</span></span>
    </div>

    <form id="shortener-form" action="{{ route('dashboard.shortener.store') }}" method="POST" class="flex flex-col gap-4 mt-6">
        @csrf
