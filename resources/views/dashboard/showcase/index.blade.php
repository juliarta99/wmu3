    ...
    @if(request()->hasAny(['search', 'year', 'sort_by']))
        <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                ...
                <a href="{{ route('dashboard.showcase.index') }}" class="hover:text-yellow-100 text-light transition duration-200 bg-main-gradient py-2 px-4 rounded-md text-sm font-medium text-center">Reset Filter</a>
            </div>
        </div>
    @endif
