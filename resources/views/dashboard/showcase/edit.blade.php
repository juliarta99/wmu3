    ...
    <form id="showcase-form" action="{{ route('dashboard.showcase.update', $showcase->slug) }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4 mt-6">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-1">
                ...
                <div class="h-27 w-48 max-w-full rounded-md border border-gray-300 bg-gray-100 flex items-center justify-center overflow-hidden aspect-video">
            ...
            <div class="flex flex-col gap-1">
                ...
                <select name="team_id" id="team_id" class="border border-gray-300 px-4 py-2 text-sm md:text-base rounded-lg @error('team_id') border-red-500 @enderror" >
                    ...
                    @foreach ($teams as $team)
                        <option value="{{ $team->id }}" {{ old('team_id', $showcase->team_id) == $team->id ? 'selected' : '' }}>{{ $team->name }} - {{ $team->year }}</option>
                    @endforeach
                </select>
                @error('team_id')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                ...
                <div class="flex flex-wrap items-center gap-5 md:gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <label for="champion_first" class="cursor-pointer">
                            <svg class="size-6 md:size-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <label for="champion_not" class="cursor-pointer">
                            <svg class="size-6 md:size-8" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
