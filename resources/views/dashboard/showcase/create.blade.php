...
@section('content')
    <div class="flex items-center gap-3">
        ...
        <span class="text-xl md:text-2xl font-bold">Add <span class="text-five">Artwork</span></span>
    </div>
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-1">
                ...
                <div class="h-27 w-48 max-w-full rounded-md border border-gray-300 bg-gray-100 flex items-center justify-center overflow-hidden">
                    <img src="{{ asset('assets/images/img-default.png') }}" id="previewCover" class="object-cover w-full h-full" alt="Preview">
                </div>
                <input 
                    type="file" 
                    name="cover" 
