class ContributorManager {
    ...
    addContributor() {
        ...
        contributorDiv.innerHTML = `
            <label for="contributor${this.contributorCount}" class="font-semibold text-sm md:text-base">
            ...
            <div class="flex items-center gap-2 md:gap-3 justify-between">
                <input 
                    ...
                    name="contributors[]" 
                    class="border w-full border-gray-300 px-4 py-2 text-sm md:text-base rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
